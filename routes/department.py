...
# =====================================================================
# 2. ROUTE: THÊM MỚI PHÒNG BAN (ÁP DỤNG EXCEPTION HANDLING)
# =====================================================================
...
# =====================================================================
# 3. ROUTE: CHỈNH SỬA THÔNG TIN PHÒNG BAN (ÁP DỤNG EXCEPTION HANDLING)
# =====================================================================
            ...
            if deleted_count > 0:
                ...
                for row in records:
                    log_activity(
                        ...
                        action="Delete",
                        record_id=int(row[0]),
                        description=f"Soft deleted department {row[1]}."
                    )
